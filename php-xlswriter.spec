...
Source0  : https://pecl.php.net/get/xlswriter-1.5.8.tgz
...
%prep
%setup -q -n xlswriter-1.5.8
cd %{_builddir}/xlswriter-1.5.8
pushd ..
cp -a xlswriter-1.5.8 buildavx2
popd
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/extensions/no-debug-non-zts-20240924/xlswriter.so
